...
namespace repopractise.Cache
{
    ...
    public class CacheAttribute : Attribute, IAsyncActionFilter
    {
        ...
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            var cacheResponse = await cacheSerivce.GetCachedResponseAsync(cacheKey);
            ...
            {
                await cacheSerivce.CacheResponseAsync(cacheKey, okObjectResult.Value, TimeSpan.FromSeconds(_timeToLiveSeconds));
            }
